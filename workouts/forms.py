...
class MensurationForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            # Balance connectée
            "poids", "imc",
            "masse_grasse", "masse_grasse_kg", "masse_sans_graisse_kg",
            "graisse_sous_cutanee_pct", "graisse_viscerale",
            "masse_musculaire_kg", "masse_musculaire_pct",
            "muscle_squelettique_kg", "muscle_squelettique_pct",
            "masse_osseuse_kg",
            "eau_corporelle_kg", "eau_corporelle_pct",
            "proteines_kg", "proteines_pct",
            "metabolisme_base", "age_biologique",
            # Mensurations manuelles
            "tour_poitrine", "tour_taille", "tour_hanches", "tour_bras", "tour_cuisse",
            "notes",
        ]
        widgets = {
            "date": forms.DateInput(attrs={"type": "date"}, format="%Y-%m-%d"),
            "poids":                    forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "imc":                      forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "masse_grasse":             forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "masse_grasse_kg":          forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "masse_sans_graisse_kg":    forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "graisse_sous_cutanee_pct": forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "graisse_viscerale":        forms.NumberInput(attrs={"min": "1",     "inputmode": "numeric"}),
            "masse_musculaire_kg":      forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "masse_musculaire_pct":     forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "muscle_squelettique_kg":   forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "muscle_squelettique_pct":  forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "masse_osseuse_kg":         forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "eau_corporelle_kg":        forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "eau_corporelle_pct":       forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "proteines_kg":             forms.NumberInput(attrs={"step": "0.01", "inputmode": "decimal"}),
            "proteines_pct":            forms.NumberInput(attrs={"step": "0.1",  "inputmode": "decimal"}),
            "metabolisme_base":         forms.NumberInput(attrs={"inputmode": "numeric"}),
            "age_biologique":           forms.NumberInput(attrs={"inputmode": "numeric"}),
